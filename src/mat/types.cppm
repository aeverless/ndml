...
struct mat
{
	...
	{
		for (auto i = 0uz; i < std::min(column_count, row_count); ++i)
		{
...
template <typename... FromTs>
mat(FromTs const&... columns) -> mat<sizeof...(FromTs), std::common_type_t<FromTs...>::dimension, typename std::common_type_t<FromTs...>::value_type>;
