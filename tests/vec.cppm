...
TEMPLATE_TEST_CASE("1d construction", "[vec][1d]", NDML_TEST_TYPES_ALL)
{
...
TEMPLATE_TEST_CASE("2d construction", "[vec][2d]", NDML_TEST_TYPES_ALL)
{
	auto const x = generate_number<TestType>();
...
TEMPLATE_TEST_CASE("3d construction", "[vec][3d]", NDML_TEST_TYPES_ALL)
{
	auto const x = generate_number<TestType>();
	auto const y = generate_number<TestType>();
...
TEMPLATE_TEST_CASE("boolean contexts", "[vec][bool]", NDML_TEST_TYPES_ALL)
{
...
TEMPLATE_TEST_CASE("iterating", "[vec][iter]", NDML_TEST_TYPES_ALL)
{
	...
	auto const w = generate_number<TestType, 128>();
...
TEST_CASE("iterators satisfy random-access semantics", "[vec][iter]")
{
	auto       v = vec4<int>{1, 2, 3, 4};
	auto const c = vec4<int>{1, 2, 3, 4};

	static_assert(std::random_access_iterator<decltype(v.begin())>);
	static_assert(std::random_access_iterator<decltype(c.begin())>);
	static_assert(std::same_as<decltype((c[0])), int const&>);

	auto middle = 2 + v.begin();
	REQUIRE(*middle == 3);
	REQUIRE(middle - v.begin() == 2);
	REQUIRE(v.begin() < middle);

	*middle = 30;
	REQUIRE(v[2] == 30);
	REQUIRE(c.cbegin()[3] == 4);
	REQUIRE(c.cend() - c.cbegin() == 4);
...
TEMPLATE_TEST_CASE("4d construction", "[vec][4d]", NDML_TEST_TYPES_ALL)
{
...
TEMPLATE_TEST_CASE("copy construction", "[vec][copy]", NDML_TEST_TYPES_ALL)
{
	auto const x = generate_number<TestType>();
	auto const y = generate_number<TestType>();
	auto const z = generate_number<TestType>();
...
TEMPLATE_TEST_CASE("move construction", "[vec][move]", NDML_TEST_TYPES_ALL)
{
	auto const x = generate_number<TestType>();
	auto const y = generate_number<TestType>();
	auto const z = generate_number<TestType>();
...
TEMPLATE_TEST_CASE("construction from smaller vector", "[vec][convert]", NDML_TEST_TYPES_ALL)
{
	auto const x = generate_number<TestType>();
	auto const y = generate_number<TestType>();
...
TEMPLATE_TEST_CASE("construction from different type", "[vec][convert]", NDML_TEST_TYPES_ALL)
{
...
TEMPLATE_TEST_CASE("copy assignment", "[vec][assign]", NDML_TEST_TYPES_ALL)
{
...
TEMPLATE_TEST_CASE("move assignment", "[vec][assign]", NDML_TEST_TYPES_ALL)
{
...
TEMPLATE_TEST_CASE("scalar construction", "[vec][scalar]", NDML_TEST_TYPES_ALL)
{
...
TEMPLATE_TEST_CASE("vector-scalar comparison equality", "[vec][compare]", NDML_TEST_TYPES_ALL)
{
	auto const x = generate_number<TestType>();
	auto const y = generate_number<TestType>();
	auto const z = generate_number<TestType>();
...
TEMPLATE_TEST_CASE("distinct vectors compare unequal", "[vec][compare]", NDML_TEST_TYPES_ALL)
{
	auto const lhs = vec3<TestType>{1, 2, 3};
	auto const rhs = vec3<TestType>{1, 2, 4};

	REQUIRE(lhs != rhs);
}

TEMPLATE_TEST_CASE("vector predicates", "[vec][predicate]", NDML_TEST_TYPES_ALL)
{
	REQUIRE(is_zero(vec3<TestType>{}));
	REQUIRE(!is_zero(vec3<TestType>{1, 0, 0}));

	REQUIRE(is_normal(vec3<TestType>{1, 0, 0}));
	REQUIRE(!is_normal(vec3<TestType>{1, 1, 0}));

	REQUIRE(is_reciprocatable(vec3<TestType>{1, 2, 3}));
	REQUIRE(!is_reciprocatable(vec3<TestType>{1, 0, 3}));
}

TEMPLATE_TEST_CASE("vector addition", "[vec][add]", NDML_TEST_TYPES_ALL)
{
...
TEMPLATE_TEST_CASE("vector subtraction", "[vec][sub]", NDML_TEST_TYPES_ALL)
{
	auto const x1 = generate_number<TestType>();
	auto const y1 = generate_number<TestType>();
	auto const z1 = generate_number<TestType>();
...
TEMPLATE_TEST_CASE("vector multiplication", "[vec][mul]", NDML_TEST_TYPES_ALL)
{
	auto const x1 = generate_number<TestType>();
	auto const y1 = generate_number<TestType>();
	auto const z1 = generate_number<TestType>();
...
TEMPLATE_TEST_CASE("vector division", "[vec][div]", NDML_TEST_TYPES_ALL)
{
...
TEMPLATE_TEST_CASE("scalar-vector multiplication", "[vec][mul][scalar]", NDML_TEST_TYPES_ALL)
{
	auto const x = generate_number<TestType, 64>();
	auto const y = generate_number<TestType, 64>();
	auto const z = generate_number<TestType, 64>();
...
TEMPLATE_TEST_CASE("scalar-vector multiplication commutative", "[vec][mul][scalar]", NDML_TEST_TYPES_ALL)
{
	auto const x = generate_number<TestType, 64>();
	auto const y = generate_number<TestType, 64>();
	auto const z = generate_number<TestType, 64>();
...
TEMPLATE_TEST_CASE("scalar-vector division", "[vec][div][scalar]", NDML_TEST_TYPES_ALL)
{
	auto const x = generate_number<TestType, 64>();
	auto const y = generate_number<TestType, 64>();
	auto const z = generate_number<TestType, 64>();
...
TEMPLATE_TEST_CASE("addition assignment", "[vec][add]", NDML_TEST_TYPES_ALL)
{
	auto const x = generate_number<TestType>();
	auto const y = generate_number<TestType>();
	auto const z = generate_number<TestType>();
...
TEMPLATE_TEST_CASE("subtraction assignment", "[vec][sub]", NDML_TEST_TYPES_ALL)
{
	auto const x = generate_number<TestType>();
	auto const y = generate_number<TestType>();
	auto const z = generate_number<TestType>();
...
TEMPLATE_TEST_CASE("multiplication assignment", "[vec][mul]", NDML_TEST_TYPES_ALL)
{
	auto const x = generate_number<TestType>();
	auto const y = generate_number<TestType>();
	auto const z = generate_number<TestType>();
...
TEMPLATE_TEST_CASE("division assignment", "[vec][div]", NDML_TEST_TYPES_ALL)
{
...
TEMPLATE_TEST_CASE("scalar multiplication assignment", "[vec][mul][scalar]", NDML_TEST_TYPES_ALL)
{
	auto const s = generate_number<TestType, 64>() + static_cast<TestType>(1);
...
TEMPLATE_TEST_CASE("scalar division assignment", "[vec][div][scalar]", NDML_TEST_TYPES_ALL)
{
...
TEMPLATE_TEST_CASE("unary plus", "[vec][unary]", NDML_TEST_TYPES_ALL)
{
	auto const x = generate_number<TestType>();
	auto const y = generate_number<TestType>();
	auto const z = generate_number<TestType>();
...
TEMPLATE_TEST_CASE("unary negation", "[vec][neg]", NDML_TEST_TYPES_ALL)
{
	auto const x = generate_number<TestType>();
	auto const y = generate_number<TestType>();
	auto const z = generate_number<TestType>();
...
TEMPLATE_TEST_CASE("swap", "[vec][swap]", NDML_TEST_TYPES_ALL)
{
	auto const a = generate_number<TestType>();
	auto const b = generate_number<TestType>();
	auto const c = generate_number<TestType>();
...
TEMPLATE_TEST_CASE("transform", "[vec][transform]", NDML_TEST_TYPES_ALL)
{
	auto const x = generate_number<TestType>();
	auto const y = generate_number<TestType>();
	auto const z = generate_number<TestType>();
...
TEMPLATE_TEST_CASE("for_each", "[vec][for_each]", NDML_TEST_TYPES_ALL)
{
	auto const x = generate_number<TestType>();
	auto const y = generate_number<TestType>();
	auto const z = generate_number<TestType>();
...
TEMPLATE_TEST_CASE("dot product", "[vec][dot]", NDML_TEST_TYPES_ALL)
{
	auto const x1 = generate_number<TestType>();
	auto const y1 = generate_number<TestType>();
	auto const z1 = generate_number<TestType>();
...
TEMPLATE_TEST_CASE("cross product", "[vec][cross]", NDML_TEST_TYPES_ALL)
{
	auto const x1 = generate_number<TestType>();
	auto const y1 = generate_number<TestType>();
	auto const z1 = generate_number<TestType>();
	...
	auto const expected_x = static_cast<TestType>(y1 * z2 - z1 * y2);
	auto const expected_y = static_cast<TestType>(z1 * x2 - x1 * z2);
	auto const expected_z = static_cast<TestType>(x1 * y2 - y1 * x2);

	REQUIRE(c.x == expected_x);
	REQUIRE(c.y == expected_y);
	REQUIRE(c.z == expected_z);
}

TEMPLATE_TEST_CASE("cross product with self is zero", "[vec][cross]", NDML_TEST_TYPES_ALL)
{
...
TEMPLATE_TEST_CASE("cross product basis orientation", "[vec][cross]", NDML_TEST_TYPES_ALL)
{
...
TEMPLATE_TEST_CASE("cross product is orthogonal to both operands", "[vec][cross]", NDML_TEST_TYPES_ALL)
{
	auto const lhs = vec3<TestType>{1, 2, 3};
	auto const rhs = vec3<TestType>{-4, 5, -6};
	auto const cr  = cross(lhs, rhs);

	REQUIRE(dot(cr, lhs) == 0);
	REQUIRE(dot(cr, rhs) == 0);
}

TEMPLATE_TEST_CASE("squared norm", "[vec][norm]", NDML_TEST_TYPES_ALL)
{
	auto const x = generate_number<TestType>();
	auto const y = generate_number<TestType>();
	auto const z = generate_number<TestType>();
...
TEMPLATE_TEST_CASE("norm", "[vec][norm]", NDML_TEST_TYPES_ALL)
{
	auto const x = generate_number<TestType>();
	auto const y = generate_number<TestType>();
	auto const z = generate_number<TestType>();
...
TEMPLATE_TEST_CASE("normal - normalized vector", "[vec][normal]", NDML_TEST_TYPES_FLOAT)
{
	auto const x = generate_number<TestType>();
	auto const y = generate_number<TestType>();
	auto const z = generate_number<TestType>();
	...
	REQUIRE_THAT(n.x, WithinRelTypeBound<TestType>(x / len));
	REQUIRE_THAT(n.y, WithinRelTypeBound<TestType>(y / len));
	REQUIRE_THAT(n.z, WithinRelTypeBound<TestType>(z / len));
}

TEMPLATE_TEST_CASE("normal really is normal", "[vec][normal]", NDML_TEST_TYPES_FLOAT)
{
	auto v = generate_vec<3, TestType, 128, false, 10.0>();
	v.x   += TestType{20};

	auto const n = normal(v);

	REQUIRE_THAT(norm(n), WithinRelTypeBound<TestType>(1.0));
}

TEMPLATE_TEST_CASE("projection", "[vec][proj]", NDML_TEST_TYPES_FLOAT)
{
...
TEMPLATE_TEST_CASE("projection along an arbitrary axis", "[vec][proj]", NDML_TEST_TYPES_FLOAT)
{
	auto const v    = vec3<TestType>{4, -2, 5};
	auto const axis = normal(vec3<TestType>{1, 2, 3});
	auto const proj = projection(v, axis);

	REQUIRE_THAT(dot(v - proj, axis), WithinAbsTypeBound<TestType>(0));
	REQUIRE(equal(projection(proj, axis), proj));
}

TEMPLATE_TEST_CASE("reciprocal", "[vec][recip]", NDML_TEST_TYPES_FLOAT)
{
...
TEMPLATE_TEST_CASE("reciprocal of all ones vector", "[vec][recip]", NDML_TEST_TYPES_FLOAT)
{
...
TEMPLATE_TEST_CASE("dimension coherence", "[vec][dim]", NDML_TEST_TYPES_ALL)
{
...
TEMPLATE_TEST_CASE("zip transform", "[vec][transform]", NDML_TEST_TYPES_ALL)
{
	auto const x = generate_number<TestType>();
	auto const y = generate_number<TestType>();
	auto const z = generate_number<TestType>();
...
TEMPLATE_TEST_CASE("zip for each", "[vec][for_each]", NDML_TEST_TYPES_ALL)
{
	auto const x = generate_number<TestType>();
	auto const y = generate_number<TestType>();
	auto const z = generate_number<TestType>();
...
TEMPLATE_TEST_CASE("chained arithmetic operations", "[vec][chain]", NDML_TEST_TYPES_ALL)
{
